...
async function Register(req, res) {
    try {
        const { uregisterId, otp, pin, username, profilePicture } = req.body;
        ...
        const newUser = new USER({ profilePicture, email: uregisterUser.email, username, password: pin, fullName: uregisterUser.fullName, isVerified: true, linkedEmails: [uregisterUser.email] });
